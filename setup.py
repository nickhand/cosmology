...
DISTNAME            = 'cosmology'
DESCRIPTION         = 'Cosmological calculations in python'
...
#-------------------------------------------------------------------------------
def write_version_py(filename='cosmology/version.py'):
    template = """# THIS FILE IS GENERATED FROM THE COSMOLOGY SETUP.PY
version='%s'
"""
